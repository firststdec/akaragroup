        ...
        <div class="c-media">
          ...
          <nav class="c-media-category u-no-sp">
            <div class="c-media-category__list">
              <div class="c-media-category__item is-active"><a class="c-media-category__link" href="<?php echo $lang_url; ?>/news/">
                  <div class="text u-ml-0">All</div></a></div>
              <?php foreach ( $terms as $term ) : ?>
                <?php if($term->slug == 'news') : ?>
                <div class="c-media-category__item"><a class="c-media-category__link" href="<?php echo $lang_url; ?>/news/<?php echo $term->slug; ?>">
          ...
          <div class="c-media-category-dropdown u-no-tb u-no-pc">
            ...
            <select class="c-media-category-select" name="category">
              ...
              <?php foreach ( $terms as $term ) : ?>
              <option value="<?php echo $lang_url; ?>/news/<?php echo $term->slug; ?>"><?php echo $term->name; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
