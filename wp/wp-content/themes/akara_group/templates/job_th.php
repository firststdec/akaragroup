...
<div class="c-box-jobs__detail" id="job-0<?php echo $no; ?>">
  <div class="c-box-jobs__inner">
    ...
    <div class="c-box-jobs__apply">
      <div class="c-box-cmn-button"><a class="c-button-cmn-01" href="<?php echo $job_application_link; ?>" target="_blank"><span class="text">สมัครงานตำแหน่งนี้</span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
    </div>
    <?php endif; ?>
  </div>
</div>
