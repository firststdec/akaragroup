          ...
          <ul class="l-header__submenu-list">
            <li class="l-header__submenu-item"><div class="l-header__submenu-link">
              ...
              ?>
                ...
                ?>
                  <a class="l-header__submenu-list-02-link" href="<?php echo $root_url; ?>/en/product/<?php echo $term->slug; ?>"><i class="circle"></i><?php echo $term->name; ?></a>
          ...
          <ul class="l-header__submenu-list">
            <li class="l-header__submenu-item">
              <ul class="l-header__submenu-list-02">
                ...
                <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="<?php echo $root_url; ?>/news/"><i class="circle"></i>News &amp; Article</a></li>
