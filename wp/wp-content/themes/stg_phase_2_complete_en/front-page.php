          ...
          <div class="c-box-card-row-01 -reverse -yellow-egg">
            ...
            <div class="box-content"><a class="js-scroll c-scroll-down-button -th" href="#scroll_yellow_egg">
              ...
              <div class="c-box-cmn-button animation-element slide-left">
                <a class="c-button-cmn-01" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/product/fresh-eggs<?php echo (is_th_lang())? '-th' : ''; ?>"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a>
              </div>
