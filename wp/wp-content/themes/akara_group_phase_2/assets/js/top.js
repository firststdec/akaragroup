(function () {
	...
	// Initiator function
	function init() {
		cvs = document.getElementById("canvas-yellow");
...
(function () {
	...
	// Initiator function
	function init() {
		cvs = document.getElementById("canvas-yellow-02");
		ctx = cvs.getContext("2d");
...
(function () {
	...
	// Initiator function
	function init() {
		cvs = document.getElementById("canvas-green-bottom");
		ctx = cvs.getContext("2d");
...
(function () {
	...
	// Initiator function
	function init() {
		cvs = document.getElementById("canvas-white-bottom");
		ctx = cvs.getContext("2d");
