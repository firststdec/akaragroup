                ...
                <div id="nav">
                  <nav class="c-media-category u-no-sp animation-element slide-top">
                    <div class="c-media-category__list">
                      ...
                      <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url ?>/recipe/<?php echo $term->slug; ?>/#nav">
                  ...
                  <div class="c-media-category-dropdown u-no-tb u-no-pc animation-element slide-top">
                    ...
                    <select class="c-media-category-select js-category-change" name="category">
                      ...
                      <?php foreach ( $terms as $term ) : ?>
                      <option value="<?php echo $root_url; ?><?php echo $lang_url ?>/recipe/<?php echo $term->slug; ?>/#nav"<?php echo ($obj->term_id == $term->term_id)? ' selected':''; ?>><?php echo $term->name; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
