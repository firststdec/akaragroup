          ...
          <div class="p-recipes">
            <div class="c-mv-sub-page">
              ...
              <?php
                if( is_th_lang() ) {
                  ...
                  $mv_subcontent = '';
                  $mv_content = 'Make every meal taste great. <br>Easy and delicious recipes that will make your favorite meals special and more interesting.';
                }
              ?>
            ...
            <?php
              ...
              if( is_th_lang() ) {
                ...
                $sub_heading = 'Choose your Favorite Recipe';
                $sub_content = 'Changing a simple recipe into a creative recipe with a variety of egg recipes from akara will turn an ordinary recipe into a special home dish.';
              }
            ?>
                ...
                <div id="nav">
                  <nav class="c-media-category u-no-sp animation-element slide-top">
                    <div class="c-media-category__list">
                      <div class="c-media-category__item"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url ?>/recipe/#nav">
                          <div class="text"><?php echo $all_recipes; ?></div></a></div>
                      <?php foreach ( $terms as $term ) : ?>
                      <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url ?>/recipe<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                  ...
                  <div class="c-media-category-dropdown u-no-tb u-no-pc animation-element slide-top">
                    ...
                    <select class="c-media-category-select js-category-change" name="category">
                      ...
                      <?php foreach ( $terms as $term ) : ?>
                      <option value="<?php echo $root_url; ?><?php echo $lang_url ?>/recipe<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav"<?php echo ($obj->term_id == $term->term_id)? ' selected':''; ?>><?php echo $term->name; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
