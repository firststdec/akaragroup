...
?>
	...
	<div class="c-fix-panel">
		<div class="inner">
			<div class="c-call">
				<a href="tel:037349885" title="โทรหาเรา 037349885" class="inner">
					<div class="icon -tel"></div>
					<div class="text"><?php echo (is_th_lang())? 'โทรหาเรา' : 'Contact Us'; ?></div>
				</a>
			</div>
			<div class="c-message">
				<a href="https://m.me/akaragroupTH" target="_blank" class="c-message">
					<div class="icon -line"></div>
					<div class="text"><?php echo (is_th_lang())? 'ส่งข้อความ' : 'Send Message'; ?></div>
				</a>
			</div>
		</div>
	</div>
					...
					<ul class="l-footer__menu-list">
						...
						<li class="l-footer__menu-item -contact-detail">
							...
							<div class="l-footer__content">
								...
								<div class="txt"><?php echo (is_th_lang())? '88 หมู่ 2 ต.ป่าขะ อ.บ้านนา จ.นครนายก 26110' : ' 88 Moo 2, Pakha Subdistrict, Ban Na District, Nakhon Nayok Province, Thailand 26110.'; ?></div>
							</div>
							<div class="l-footer__content">
								<div class="heading"><?php echo (is_th_lang())? 'วันและเวลาทำการ' : 'Business hours';?></div>
								<div class="txt"><?php echo (is_th_lang())? 'วันจันทร์ – วันเสาร์ 08.00 – 17.00' : 'Monday - Saturday 08.00 - 17.00';?></div>
							</div>
						</li>
...
<script src="/assets/js/common.js?v=2021-4-28-1"></script>
<script src="/assets/js/loadmore.js?v=2021-3-3-1"></script>
...
<script src="/assets/js/bundle.js?v=2021-3-3-1"></script>
