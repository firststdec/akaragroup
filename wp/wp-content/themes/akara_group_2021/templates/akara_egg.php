...
<main class="l-container">
  <div class="l-container__inner">
          ...
          <div class="c-product-heading">
            ...
            ?>
              ...
              <div class="c-product-local-nav__item <?php echo ($term_obj->slug == $term->slug)? 'is-active':''; ?>">
                <a class="c-product-local-nav__link" href="<?php echo esc_url( $root_url .'/en/product_category/' . $term->slug ); ?>">
    ...
    ?>
        ...
        <div class="c-product-list__inner">
          <div class="c-product-list__box-product-show">
            <div class="c-product-list__box-product-show-heading animation-element slide-top">
              <div class="c-product-list__box-product-show-heading-text"><?php echo (is_th_lang())? 'เลือกผลิตภัณฑ์':'Choose a product'; ?></div>
            </div>
      ...
      <?php if( $banner['url'] != '' ): ?>
      <div class="l-sec-cmn-01 -video-section p-our-story u-mt-0 animation-element slide-top u-mb-130">
          ...
          <div class="inner">
            <div class="c-box-heading-center-text">
              <div class="inner">
                ...
                <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01 --border-base" href="<?php echo $root_url . $lang_url; ?>/recipe/"><span class="text"><?php echo $readmore; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
              </div>
            </div>
          </div>
        </div>
