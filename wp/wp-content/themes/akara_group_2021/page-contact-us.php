            ...
            <div class="c-mv-sub-page">
              <div class="c-mv-sub-page__inner">
                <div class="c-mv-sub-page__box-content">
                  ...
                  <?php endif; ?>
                  <a class="c-mv-sub-page__anchor-icon js-scroll c-scroll-down-button__static-page" href="#scroll_timeline" <?php echo (!is_th_lang())? 'style="bottom: -100px;"':''; ?>>
                ...
                <div class="c-box-time-line__list" id="scroll_timeline">
                  <div class="c-box-time-line__item animation-element slide-top">
                    ...
                    <div class="c-box-time-line__content">
                      <div class="c-box-time-line__content-heading -small"><?php echo ( is_th_lang() )? 'บริษัท อัครากรุ๊ป จำกัด' : 'Akara Group Co., Ltd.'; ?></div>
                      <ul class="c-box-time-line__content-list">
                        <li class="c-box-time-line__content-list-item"><i class="icon-time"></i>
                          <div class="c-box-detail" style="flex: 1;">
                            <div class="heading"><?php echo ( is_th_lang() )? 'วันและเวลาทำการ' : 'Business Hours'; ?></div>
                            <div class="detail"><?php echo ( is_th_lang() )? 'วันจันทร์-วันเสาร์ : 8.00 น. –  17.00 น.' : 'Mon-Sat: 8.00 - 17.00'; ?></div>
                          </div>
                        </li>
                        <li class="c-box-time-line__content-list-item"><i class="icon-location"></i>
                          <div class="c-box-detail" style="flex: 1;">
                            <div class="heading"><?php echo (is_th_lang())? 'ที่อยู่' : 'Address'; ?> | <a class="link" href="https://goo.gl/maps/8JLnQ471f7GTyRYa8" target="_blank"><?php echo (is_th_lang())? 'คลิกดูแผนที่' : 'Find Location'; ?></a></div>
                            <div class="detail"><?php echo (is_th_lang())? '88 หมู่ 2 ต.ป่าขะ อ.บ้านนา จ.นครนายก 26110':'88 Moo 2, Pakha Subdistrict, Ban Na District, <br>Nakhon Nayok Province, Thailand 26110.'; ?></div>
                          </div>
                        </li>
                        ...
                        <li class="c-box-time-line__content-list-item"><i class="icon-tel"></i>
                          <div class="c-box-detail -full">
                            <div class="heading"><?php echo (is_th_lang())? 'เบอร์โทรศัพท์' : 'Tel'; ?></div>
                            <div class="detail"><a href="tel:037349885" title="<?php echo (is_th_lang())? 'โทรหาเรา':'Call Us'; ?> 037-349-885" class="c-link-cmn-03">037-349-885</a>, <a href="tel:0923807771" title="<?php echo (is_th_lang())? 'โทรหาเรา':'Call Us'; ?> 0923807771"" class="c-link-cmn-03">092-380-7771</a></div>
                          </div>
                        </li>
                        <li class="c-box-time-line__content-list-item"><i class="icon-fax"></i>
                          <div class="c-box-detail">
                            <div class="heading"><?php echo (is_th_lang())? 'เบอร์แฟกซ์':'Fax'; ?></div>
