      ...
      ?>
        <div class="c-media">
          ...
          <div id="nav">
            <nav class="c-media-category u-no-sp">
              <div class="c-media-category__list">
                <div class="c-media-category__item is-active"><a class="c-media-category__link" href="<?php echo $lang_url; ?>/media/#nav">
                    <div class="text u-ml-0">All</div></a></div>
                <?php foreach ( $terms as $term ) : ?>
                  <?php if($term->slug == 'article') : ?>
                  <div class="c-media-category__item"><a class="c-media-category__link" href="<?php echo $lang_url; ?>/media/<?php echo $term->slug; ?>/#nav">
            ...
            <div class="c-media-category-dropdown u-no-tb u-no-pc">
              ...
              <select class="c-media-category-select js-category-change" name="category">
                ...
                <?php foreach ( $terms as $term ) : ?>
                <option value="<?php echo $lang_url; ?>/media/<?php echo $term->slug; ?>/#nav"><?php echo $term->name; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="c-box-cmn-button animation-element slide-top --center">
            ...
            <div class="c-button-cmn-01 --border-base akara_loadmore_dynamic" data-post-type="media"><span class="text">SEE MORE</span><span class="arrow"><i class="fa fa-arrow-right"></i></span></div>
          </div>
          <?php
            wp_reset_query();
            endif;
