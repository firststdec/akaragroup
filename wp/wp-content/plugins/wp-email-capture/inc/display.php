...
function wp_email_capture_form( $error = "" ) {
	...
	<div id="wp_email_capture">
		<form name="wp_email_capture" class="c-input-row"method="post" action="<?php echo $url; ?>">
			...
			?>
			<label style="display: none;" class="wp-email-capture-name wp-email-capture-label wp-email-capture-widget-worldwide wp-email-capture-name-widget wp-email-capture-name-label wp-email-capture-name-label-widget<?php if (get_option("wp_email_capture_name_required") == 1 ) { $display .= " wp-email-capture-required"; } ?>" for="wp-email-capture-name-widget"><?php _e('Name:','wp-email-capture'); ?></label> <input style="display: none;" name="wp-email-capture-name" id="wp-email-capture-name-widget" type="text" class="c-input -text wp-email-capture-name wp-email-capture-input wp-email-capture-widget-worldwide wp-email-capture-name-widget wp-email-capture-name-input wp-email-capture-name-input-widget" title="Name" value="Akara Member"/><br/>

			<label style="display: none;" class="wp-email-capture-email wp-email-capture-label wp-email-capture-widget-worldwide wp-email-capture-email-widget wp-email-capture-email-label wp-email-capture-email-label-widget"  for="wp-email-capture-email-widget"><?php _e('Email:','wp-email-capture'); ?></label> <input name="wp-email-capture-email" id="wp-email-capture-email-widget" type="text" class="c-input -text wp-email-capture-email wp-email-capture-input wp-email-capture-widget-worldwide wp-email-capture-email-widget wp-email-capture-email-input wp-email-capture-email-input-widget" title="Email" placeholder="Your Email Address"/><br/>
