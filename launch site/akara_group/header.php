...
<head>
  ...
  ?>
	...
	<link rel="shortcut icon" type="image/x-icon" href="/akara/favicon.ico">
  ...
  <div class="l-wrapper">
    <header class="l-header <?php echo $white_theme; ?>">
      ...
      <?php if(ICL_LANGUAGE_CODE == 'en'): ?>
        <div class="l-header__logo"><a class="l-header__logo-link" href="/akara/en/"><img class="l-header__logo-image" src="/assets/img/common/logo.svg" alt="Akara Group"><img class="l-header__logo-image white" src="/assets/img/common/logo_white.svg" alt="Akara Group"><img class="l-header__logo-image-sp" src="/assets/img/common/logo_sp.svg" alt="Akara Group"></a></div>
      <?php elseif(ICL_LANGUAGE_CODE == 'th'): ?>
        <div class="l-header__logo"><a class="l-header__logo-link" href="/akara/"><img class="l-header__logo-image" src="/assets/img/common/logo.svg" alt="Akara Group"><img class="l-header__logo-image white" src="/assets/img/common/logo_white.svg" alt="Akara Group"><img class="l-header__logo-image-sp" src="/assets/img/common/logo_sp.svg" alt="Akara Group"></a></div>
      <?php endif; ?>
            ...
            <div class="l-header__utility-in">
              ...
              <nav class="l-header__menu">
                ...
                <ul class="l-header__menu-list">
                        ...
                        <ul class="l-header__submenu-list">
                          <li class="l-header__submenu-item"><div class="l-header__submenu-link">
                            ...
                            ?>
                              ...
                              ?>
                                <a class="l-header__submenu-list-02-link" href="/akara/en/product_category/<?php echo $term->slug; ?>"><i class="circle"></i><?php echo $term->name; ?></a>
                            ...
                            ?>
                              <li class="l-header__submenu-list-02-item">
                                ...
                                ?>
                                <a class="l-header__submenu-list-02-link" href="/akara/product/<?php echo $term->slug; ?>"><i class="circle"></i><?php echo $term->name; ?></a>
                                <?php endif; // if($term_type == $product_category_type):?>
                              <?php endforeach; ?>
                              </li>
                            <?php endif; ?>
                  ...
                  <li class="l-header__menu-item"><a class="l-header__menu-link" href="/akara/en/our-story/"><span class="l-header__menu-mark">OUR STORY</span></a></li>
                  <li class="l-header__menu-item"><a class="l-header__menu-link" href="/akara/en/recipe/"><span class="l-header__menu-mark">RECIPES</span></a></li>
                      ...
                      <div class="l-header__submenu-in">
                        <ul class="l-header__submenu-list">
                          <li class="l-header__submenu-item">
                            <ul class="l-header__submenu-list-02">
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/en/about-us/"><i class="circle"></i>AKARA GROUP</a></li>
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/en/faq/"><i class="circle"></i>FAQ</a></li>
                              <?php /*
                              ...
                              */ ?>
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/en/contact-us/"><i class="circle"></i>CONTACT US</a></li>
                            </ul>
                          </li>
                        </ul>
                      </div>
              ...
              <nav class="l-header__menu">
                ...
                <ul class="l-header__menu-list">
                  ...
                  <li class="l-header__menu-item"><a class="l-header__menu-link" href="/akara/our-story/"><span class="l-header__menu-mark">เรื่องราวของเรา</span></a></li>
                  <li class="l-header__menu-item" style="display: none;"><a class="l-header__menu-link" href="/akara/recipe/"><span class="l-header__menu-mark">สูตรอาหาร</span></a></li>
                    ...
                    <div class="l-header__submenu -about-us">
                      <div class="l-header__submenu-in">
                        <ul class="l-header__submenu-list">
                          <li class="l-header__submenu-item">
                            <ul class="l-header__submenu-list-02">
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/about-us/"><i class="circle"></i>เกี่ยวกับอัครากรุ๊ป</a></li>
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/faq/"><i class="circle"></i>คำถามที่พบบ่อย</a></li>
                              <?php /*
                              ...
                              */ ?>
                              <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="/akara/contact-us/"><i class="circle"></i>ติดต่อเรา</a></li>
                            </ul>
                          </li>
                        </ul>
                      </div>
              ...
              <div class="c-box-search__detail" id="box-search">
                <div class="c-box-search__inner">
                  <form role="search" class="c-search-form" action="/akara/search" method="get">
              ...
              <?php if(ICL_LANGUAGE_CODE == 'en'): ?>
              <div class="l-header__nav-trigger"><a class="l-header__nav-link c-button-middle c-button--orange -btn-where-to-buy" href="/akara/en/where-to-buy/">
              ...
              <?php elseif(ICL_LANGUAGE_CODE == 'th'): ?>
              <div class="l-header__nav-trigger"><a class="l-header__nav-link c-button-middle c-button--orange -btn-where-to-buy" href="/akara/where-to-buy/">
