          ...
          <div class="p-media-detail">
              ...
              <div class="c-mv-sub-page__inner">
                ...
                <div class="c-mv-sub-page__box-image">
                  <figure class="c-mv-sub-page__image-frame">
                    <?php if(get_field('media_mainvisual') != ''): ?>
                      <?php $img = get_field('media_mainvisual'); ?>

                    <img src="<?php echo $img['url']; ?>" alt="<?php echo $img['alt']; ?>">
                    <?php else: ?>
                    <img class="u-no-sp" src="/assets/img/media/img_media_detail.png" alt="">
                    <img class="u-no-pc u-no-tb" src="/assets/img/media/img_media_detail.png" alt="">
                    <?php endif; ?>
                  </figure>
                </div>
              </div>
            ...
            <div class="c-relate-post animation-element slide-top">
              <div class="c-relate-post__inner">
                <div class="c-relate-post__heading animation-element slide-top">Related Media</div>
