...
<main class="l-container">
  <div class="l-container__inner">
    <div class="p-top">
        ...
        <div class="inner">
          <div class="c-box-card-row-01 -reverse -yellow-egg">
            ...
            <div class="box-content"><a class="js-scroll c-scroll-down-button -th" href="#scroll_yellow_egg">
              ...
              <div class="c-box-cmn-button animation-element slide-left">
                <a class="c-button-cmn-01" href="/akara<?php echo $lang_url; ?>/product/fresh-eggs-th"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a>
              </div>
          ...
          <div class="c-box-card-row-01 -green-egg">
            ...
            <div class="box-content">
              ...
              <?php endif;?>
              <div class="c-box-cmn-button animation-element slide-right"><a class="c-button-cmn-01 animation-element slide-top" href="/akara<?php echo $lang_url; ?>/products/organic"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
          ...
          <div class="c-box-card-row-01 -reverse -orange-egg">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-left"><a class="c-button-cmn-01" href="/akara/products/mori-tama"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
        ...
        <div class="inner">
          <div class="c-box-card-row-01">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01" href="/akara/our-story"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
            </div>
          ...
          <div class="c-box-card-row-01 -reverse">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01" href="/akara/about-us"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
            </div>
          </div>
        </div>
        <div class="c-wave-yellow-bottom">
      ...
      <div class="l-sec-cmn-01 -recipes-top-heading u-d-none">
      ...
      <div class="l-sec-cmn-01 l-sec-box-swiper-voice animation-element slide-top u-d-none">
        <div class="inner">
