        ...
        <div class="inner">
          <div class="c-box-card-row-01 -reverse -yellow-egg">
            ...
            <div class="box-content"><a class="js-scroll c-scroll-down-button -th" href="#scroll_yellow_egg">
              ...
              <div class="c-box-cmn-button animation-element slide-left">
                <a class="c-button-cmn-01" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/product<?php echo (!is_th_lang())? '_category' : ''; ?>/fresh-eggs<?php echo (is_th_lang())? '-th' : ''; ?>"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a>
              </div>
          ...
          <div class="c-box-card-row-01 -reverse -orange-egg">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-left"><a class="c-button-cmn-01" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/products/mori-tama"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
        ...
        <div class="inner">
          <div class="c-box-card-row-01">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/our-story"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
            </div>
          ...
          <div class="c-box-card-row-01 -reverse">
            ...
            <div class="box-content">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/about-us"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
            </div>
          </div>
        </div>
        <div class="c-wave-yellow-bottom">
        ...
        <div class="inner">
          <div class="c-box-heading-center-text">
            <div class="inner">
              ...
              <?php endif; ?>
              <div class="c-box-cmn-button animation-element slide-top"><a class="c-button-cmn-01 --border-base -is-active" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/recipe/"><span class="text"><?php echo $readmore_text; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></a></div>
            </div>
          </div>
        </div>
      </div>
