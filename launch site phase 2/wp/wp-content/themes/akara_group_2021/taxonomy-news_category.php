...
?>
  <?php
    if( !is_th_lang() ) {
      $mv_heading = 'News &amp; Articles';
      $mv_content = 'Follow akara News and Activities here...';
    } elseif( is_th_lang() ) {
      ...
      <div class="p-media">
        ...
        <div class="c-media">
          ...
          <div id="nav">
            <nav class="c-media-category u-no-sp">
              <div class="c-media-category__list">
                <div class="c-media-category__item"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news/#nav">
                    <div class="text u-ml-0"><?php echo (!is_th_lang())? 'All' : 'ทั้งหมด'; ?></div></a></div>
                <?php foreach ( $terms as $term ) : ?>
                  <?php if($term->slug == 'news' || $term->slug == 'news-en') : ?>
                  <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                  ...
                  <?php elseif($term->slug == 'social-activity' || $term->slug == 'social-activity-en'): ?>
                  <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                    ...
                    <div class="text"><?php echo $term->name; ?></div></a></div>
                  <?php elseif($term->slug == 'marketing-activity' || $term->slug == 'marketing-activity-en'): ?>
                  <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                    <div class="icon -tv">
                    ...
                    <div class="text"><?php echo $term->name; ?></div></a></div>
                  <?php elseif($term->slug == 'video' || $term->slug == 'video-en'): ?>
                  <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                    <div class="icon -tv">
                    ...
                    <div class="text"><?php echo $term->name; ?></div></a></div>
                  <?php elseif($term->slug == 'article' || $term->slug == 'article-en'): ?>
                  <div class="c-media-category__item<?php echo ($obj->term_id == $term->term_id)? ' is-active':''; ?>"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
                    <div class="icon -tv">
            ...
            <div class="c-media-category-dropdown u-no-tb u-no-pc">
              ...
              <select class="c-media-category-select js-category-change" name="category">
                <option value="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/#nav"><?php echo (!is_th_lang())? 'All' : 'ทั้งหมด'; ?></option>
                <?php foreach ( $terms as $term ) : ?>
                <option value="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav"<?php echo ($obj->term_id == $term->term_id)? ' selected':''; ?>><?php echo $term->name; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="c-box-cmn-button animation-element slide-top --center">
            ...
            <div class="c-button-cmn-01 --border-base akara_loadmore_dynamic -is-active" data-post-type="news"><span class="text"><?php echo (is_th_lang())? 'อ่านเพิ่มเติม' : 'SEE MORE'; ?></span><span class="arrow"><i class="fa fa-arrow-right"></i></span></div></div>
          <?php
            wp_reset_query();
            endif;
          ?>
