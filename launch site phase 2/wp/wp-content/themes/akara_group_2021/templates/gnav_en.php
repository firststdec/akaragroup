      ...
      <div class="l-header__submenu">
        <div class="l-header__submenu-in">
          <ul class="l-header__submenu-list">
            ...
            ?>
            <li class="l-header__submenu-item"><div class="l-header__submenu-link">
                <figure class="image" data-match-height="mega-menu"><img src="/assets/img/common/menu-akara-eggology@2x.png?v=1" alt="AKARA EGGOLOGY"></figure><span class="l-header__submenu-text">AKARA EGGOLOGY</span></div>
              <ul class="l-header__submenu-list-02">
        ...
        <div class="l-header__submenu-in">
          <ul class="l-header__submenu-list">
            <li class="l-header__submenu-item">
              <ul class="l-header__submenu-list-02">
                <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="<?php echo $root_url; ?>/en/about-us/"><i class="circle"></i>About <span class="u-lowercase-letter">akara group</span></a></li>
                ...
                <li class="l-header__submenu-list-02-item"><a class="l-header__submenu-list-02-link" href="<?php echo $root_url; ?>/en/news/"><i class="circle"></i>News &amp; Article</a></li>
