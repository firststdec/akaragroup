  ...
  <div class="c-media-list__card">
    ...
    <?php if($tags[0]->term_id != ''): ?>
      <div class="c-media-list__category">
        <?php if($tags[0]->slug == 'social-activity' || $tags[0]->slug == 'social-activity-en'): ?>
        ...
        <?php elseif($tags[0]->slug == 'marketing-activity' || $tags[0]->slug == 'marketing-activity-en'): ?>
        <div class="icon -tv">
        ...
        <?php elseif($tags[0]->slug == 'news' || $tags[0]->slug == 'news-en'): ?>
        ...
        <?php elseif($tags[0]->slug == 'video' || $tags[0]->slug == 'video-en'): ?>
        <div class="icon -press">
        ...
        <?php elseif($tags[0]->slug == 'article' || $tags[0]->slug == 'article-en'): ?>
        <div class="icon -press">
