          ...
          <div id="nav">
            <nav class="c-media-category u-no-sp">
              <div class="c-media-category__list">
                <div class="c-media-category__item is-active"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news/#nav">
                    <div class="text u-ml-0"><?php echo (!is_th_lang())? 'All' : 'ทั้งหมด'; ?></div></a></div>
                <?php foreach ( $terms as $term ) : ?>
                  <?php if($term->slug == 'news' || $term->slug == 'news-en') : ?>
                  <div class="c-media-category__item"><a class="c-media-category__link" href="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav">
            ...
            <div class="c-media-category-dropdown u-no-tb u-no-pc">
              ...
              <select class="c-media-category-select js-category-change" name="category">
                ...
                <?php foreach ( $terms as $term ) : ?>
                <option value="<?php echo $root_url; ?><?php echo $lang_url; ?>/news<?php echo (!is_th_lang())? '_category':''; ?>/<?php echo $term->slug; ?>/#nav"><?php echo $term->name; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
