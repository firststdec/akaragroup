          ...
          <div class="l-header__utility-wrap">
            <div class="l-header__utility-in">
              ...
              <div class="l-language-bar">
                ...
                <?php if( !is_th_lang() ): ?>
                <a class="c-link is-active" href="<?php echo $root_url; ?><?php echo $wpml_permalink; ?>"><span class="icon -th"><img src="/assets/img/common/flag-thai.svg" alt=""></span></a>
                <?php elseif( is_th_lang() ): ?>
                <a class="c-link is-active" href="<?php echo $root_url; ?><?php echo $wpml_permalink; ?>"><span class="icon -eng"><img src="/assets/img/common/flag-eng.svg" alt=""></span></a>
                <?php endif; ?>
              </div>
            </div>
          </div>
